...
<div class="admin-wrapper">
    ...
    <main class="admin-main">
        <div class="admin-topbar">
            <h1>Products</h1>
            <a href="/pitstop/admin/add-product.php" class="btn-admin btn-admin-gold">Add New Product</a>
        </div>
        <div class="admin-content">
            <table class="admin-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <img src="/pitstop/<?php echo htmlspecialchars($p['image_url']); ?>" alt="" style="width:56px;height:56px;object-fit:cover;border-radius:3px;">
                        </td>
                        ...
                        <td style="white-space:nowrap;">
                            <a href="/pitstop/admin/edit-product.php?id=<?php echo $p['id']; ?>" class="btn-admin btn-admin-dark" style="margin-right:6px;">Edit</a>
                            <a href="/pitstop/admin/delete-product.php?id=<?php echo $p['id']; ?>" class="btn-admin btn-admin-danger" onclick="return confirm('Delete this product?')">Delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
